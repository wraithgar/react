...
const useIntersectionObserver = (root, activeCategoryRef, filterResultRef, renderOne) => {
  ...
  useEffect(() => {
    ...
    if (globalObject.IntersectionObserver !== undefined && root.current && !filterResultRef.current && !renderOne) {
